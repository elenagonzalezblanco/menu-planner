...
const recipes = [
  ...
  // Otros
  { name: "Tortilla de patata", category: "otro", ingredients: ["Huevos", "Patatas", "Cebolla", "Tomates"], instructions: "" },
  { name: "Albóndigas", category: "otro", ingredients: ["Carne picada", "Pan bimbo", "Tomates", "Huevos"], instructions: "" },
  { name: "Espaguetis", category: "otro", ingredients: ["Espaguetis", "Tomates", "Queso rallado de pasta"], instructions: "" },
  { name: "Arroz blanco con tomate y jamón York", category: "otro", ingredients: ["Arroz", "Jamón York", "Tomates", "Ajos"], instructions: "" },
  { name: "Arroz a la milanesa", category: "otro", ingredients: ["Arroz", "Champiñones", "Vino blanco", "Queso rallado fuerte tipo pasta"], instructions: "" },
  ...
  { name: "Patatas de remoste", category: "otro", ingredients: ["Patatas", "Cebolla frita", "Chorizo"], instructions: "" },
  ...
  { name: "Sandwich", category: "otro", ingredients: ["Pan bimbo", "Jamón york", "Queso lonchas", "Nata"], instructions: "" },
  { name: "Jamoncitos", category: "otro", ingredients: ["Jamón cortado 1 dedo de gordo", "Harina", "Huevo", "Pan rallado"], instructions: "" },
  { name: "Calabacín con tomate arcoiris", category: "otro", ingredients: ["Calabacín", "Tomates", "Nata", "Queso rallado", "Queso gouda o havarti"], instructions: "" },
  { name: "Atún con tomate", category: "otro", ingredients: ["Atún", "Tomate", "Cebolla"], instructions: "" },
...
async function seed() {
  ...
  if (existing.length > 0) {
    console.log(`Already have ${existing.length} recipes. Skipping seed.`);
    process.exit(0);
  }
